  ...
  <div class="q-ma-xl ">
    <div class="row justify-center q-col-gutter-md">
      <div class="col-12 col-md-auto ">
        <q-input v-model="width" label="Width" @keyup.enter="refresh()" />
      </div>

      <div class="col-12 col-md-auto">
        <q-input v-model="height" label="Height" @keyup.enter="refresh()" />
      </div>

      <div class="col-12 col-md-auto">
        <q-btn color="primary" label="Refresh" @click.prevent="refresh()" />
      </div>
      <div class="col-12 col-md-auto">
