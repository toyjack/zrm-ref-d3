<script setup>
  ...
  const drawSvg = () => Icicle(nested_data, svgRef,
    {
  ...
  const refresh = () => {
    // empty svg
    d3.select("#mysvg").select("svg").remove();
    drawSvg()
  }
    ...
    <div class="columns">
      <div class="column is-4">
        <div class="field">
          ...
          <div class="control">
            <input class="input" type="text" v-model="width" @keyup.enter="refresh()">
          </div>
        </div>
      </div>
      ...
      <div class="column is-4">
        <div class="field">
          ...
          <div class="control">
            <input class="input" type="text" v-model="height" @keyup.enter="refresh()">
          </div>
        </div>
      </div>
      <div class="column is-2">
        <a class="button" @click.prevent="refresh()">Refresh</a>
      </div>
      <div class="column is-2">
        <a class="button" @click.prevent="download()">Download</a>
      </div>
    </div>
